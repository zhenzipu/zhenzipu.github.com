...
/**
 * Adds the label menu items to the given menu and parent.，添加属性到Arrange 面板
 */
ArrangePanel.prototype.init = function()
{
	var graph = this.editorUi.editor.graph;
	var ss = this.format.getSelectionState();
    this.addBaseArrange(this.container);
...
ArrangePanel.prototype.addBaseArrange = function(container){
       ...
       var span = document.createElement('div');
        ...
        mxUtils.write(span, "基本属性");
        div.appendChild(span);

	  var btn1 = mxUtils.button("名称", function(evt)
    {
        console.log("click");
    })
    btn1.setAttribute('title', "名称");
    btn1.style.marginTop = '20px';
    btn1.style.width = '80px';
    div.appendChild(btn1);

    var btn2 = mxUtils.button("属性值", function(evt)
    {
        console.log("click");
    })
    btn2.setAttribute('title', "属性值");
    btn2.style.marginTop = '20px';
    btn2.style.width = '80px';
    div.appendChild(btn2);

    var btn2 = mxUtils.button("选中", function(evt)
    {
        console.log("click");
    })
    btn2.setAttribute('title', "选中");
    btn2.style.marginTop = '20px';
    ...
    var checkbox = mxUtils.button("", mxUtils.bind(this, function(evt)
    {
    	var value =input1.value;
        this.editorUi.actions.get('changeCellValue').funct(value);
    }));
    ...
    var checkbox2 = mxUtils.button("");
    checkbox2.style.whiteSpace = 'nowrap';
    checkbox2.style.overflow = 'hidden';
   ...
   function createInput() {
       ...
       input1.style.marginTop = '0px';
       input1.style.fontWeight = 'bold';
       input1.style.borderWidth = "1px";
       input1.style.borderColor = "rgb(192, 192, 192)";
       input1.style.borderStyle = "solid";
       input1.style.borderImage = "initial";
