...
{
	var fns = [
	 	this.createVertexTemplateEntry('whiteSpace=wrap;html=1;', 80, 80, '测试属性', '正方形', null, null, 'rect rectangle box'),
	 	this.createVertexTemplateEntry('rounded=1;whiteSpace=wrap;html=1;', 120, 60, '', '矩形	', null, null, 'rounded rect rectangle box'),
 		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;', 80, 80, '', '圆型', null, null, 'oval ellipse state'),
        this.createVertexTemplateEntry('rhombus;whiteSpace=wrap;html=1;', 120, 80, '', '菱形', null, null, 'diamond rhombus if condition decision conditional question test')
